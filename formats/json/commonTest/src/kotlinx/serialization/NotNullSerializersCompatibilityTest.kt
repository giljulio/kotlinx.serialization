 ...
 */
@file:UseSerializers(NotNullSerializersCompatibilityTest.NonNullableIntSerializer::class)
@file:UseContextualSerialization(NotNullSerializersCompatibilityTest.FileContextualType::class)
...
class NotNullSerializersCompatibilityTest {
